...
COMMENT 기능 및 동작 설명(현재 가능한 기능)
[페이지 들어오자마자]
- id를 서버에 전송하여 내글 목록 받아오기
- id를 서버에 전송하여 기초 진도현황 받아오기
- id를 서버에 전송하여 심화 진도현황 받아오기
- 프로필에 카메라 버튼 클릭시 이미지 추가 가능한 창이 뜨고 이미지를 올린 후 저장 누르면 프로필 저장 완료 시 알림.
- 내 글 목록은 내글 20글자 이상 간략하게 보이기 때문에 클릭하면 모든 글을 읽을 수 있다. 
