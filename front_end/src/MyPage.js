    ...
    return (
        <div>
            <Header>
                ...
                <UserInfo>
                    <img src={profile} style={{width: "35px", height: "35px", borderRadius: "30px", margin: "auto 5px"}}></img>
            ...
            <Container>
                <Profile>
                    ...
                    <ProfileBtn><img src={profileButton}></img></ProfileBtn>
                </Profile>
                ...
                <div>
                    <div>
                        <Title>진도 현황</Title>
                        <Class>
                            <img src={contentImage} style={{borderTopLeftRadius: "15px", borderBottomLeftRadius: "15px"}} />
                            <div style={{display: "flex", flexDirection: "column", textAlign: "left", margin: "auto", width: "150px"}}>
                                <div style={{fontWeight: "bold"}}>1차시</div>
                                <div style={{fontSize: "14px", marginTop: "5px"}}>개미와 베짱이</div>
                            </div>
                            <div style={{display: "flex", margin: "auto 0"}}>
                                <Progress done="40%" />
                                <text style={{marginLeft: "15px", lineHeight: "10px", color: "#A7A7A7"}}>40%</text>
                            </div>
                            <PlayButton><img src={playIcon}></img></PlayButton>
                        </Class>
                        <Class>
                            <img src={contentImage} style={{borderTopLeftRadius: "15px", borderBottomLeftRadius: "15px"}} />
                            <div style={{display: "flex", flexDirection: "column", textAlign: "left", margin: "auto", width: "150px"}}>
                                <div style={{fontWeight: "bold"}}>2차시</div>
                                <div style={{fontSize: "14px", marginTop: "5px"}}>알라딘의 요술램프</div>
                            </div>
                            <div style={{display: "flex", margin: "auto 0"}}>
                                <Progress done="40%" />
                                <text style={{marginLeft: "15px", lineHeight: "10px", color: "#A7A7A7"}}>40%</text>
                    ...
                    <div>
                        ...
                        <Question>
                            ...
                            <text style={{position: "relative", top: "-44px", left: "480px"}}>작성일: 2021.07.24 오전 11:30</text>
                            <text style={{position: "relative", left: "-210px"}}>3강을 수강하는 중에 에러가 납니다. 어떻게 해야할까요?</text>
                        </Question>
                        <Question>
                            <h4>Basic 3강에서 질문있습니다! 자꾸 에러가 나요</h4>
                            <text style={{position: "relative", top: "-44px", left: "480px"}}>작성일: 2021.07.24 오전 11:30</text>
                ...
                <div style={{margin: "auto"}}>
                    ...
                    <div style={{boxShadow: "4px 4px 4px 4px #D6D6D6", borderRadius: "10px", padding: "20px", width: "250px", height: "260px"}}>
